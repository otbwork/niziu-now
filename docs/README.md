# NiziU NOW — 最新情報まとめアプリ

NiziU（JYP／Sony Music）の最新情報を、**完全無料**で自動集約するアプリです。
ニュース・YouTube・グッズなどを定期的に収集し、**情報の信頼度（公式 / 大手 / 未確認）** を
...
3. **Actions** タブで `NiziU NOW - 収集とデプロイ` を一度 **Run workflow**
...
- 収集間隔: `.github/workflows/niziu-pages.yml` の `cron`
